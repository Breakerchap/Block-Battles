...
execute if score global current_turn matches 0 run scoreboard players operation blue health -= temp temp
# Blue (damage)
...
execute if score global current_turn matches 1 run scoreboard players operation red health -= temp temp
...
execute if score global current_turn matches 0 run scoreboard players operation red health += temp temp
# Blue (healing)
...
execute if score global current_turn matches 1 run scoreboard players operation blue health += temp temp
...
#! Jungle Log
# Red (defense)
execute if score global current_turn matches 0 run scoreboard players operation temp temp = red count_jungle_log
execute if score global current_turn matches 0 run scoreboard players operation temp temp *= jungle_log defense
execute if score global current_turn matches 0 run scoreboard players operation red defense += temp temp
# Blue (defense)
execute if score global current_turn matches 0 run scoreboard players operation temp temp = blue count_jungle_log
execute if score global current_turn matches 0 run scoreboard players operation temp temp *= jungle_log defense
execute if score global current_turn matches 0 run scoreboard players operation blue defense += temp temp

#! Jungle Log
# Red (defense)
execute if score global current_turn matches 0 run scoreboard players operation temp temp = red count_nether_bricks
execute if score global current_turn matches 0 run scoreboard players operation temp temp *= nether_bricks defense
execute if score global current_turn matches 0 run scoreboard players operation red defense += temp temp
# Blue (defense)
execute if score global current_turn matches 0 run scoreboard players operation temp temp = blue count_nether_bricks
execute if score global current_turn matches 0 run scoreboard players operation temp temp *= nether_bricks defense
execute if score global current_turn matches 0 run scoreboard players operation blue defense += temp temp